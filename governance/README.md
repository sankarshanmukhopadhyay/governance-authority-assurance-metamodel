...
- [`reviews/`](reviews/) contains structured privacy, security, affected-party, interoperability and implementation-evidence records.
- The [Candidate Readiness Dashboard](../docs/candidate-readiness.md) summarises the current state.
