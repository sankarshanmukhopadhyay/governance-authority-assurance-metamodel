---
title: "Cross-Jurisdiction Policy Conflict"
permalink: /examples/cross-jurisdiction-policy-conflict/
parent: "Implementation Patterns"
nav_order: 90
artifact_type: Informative research pattern
normative_status: Informative
---
# Cross-Jurisdiction Policy Conflict
...
This pattern examines **conflicting legal and governance contexts**. It is linked to future-enhancement candidate `FE-023` and is intended to generate implementation evidence before any promotion decision.

## Scenario

The scenario uses the experimental record `experimental-risk-acceptance.valid.json` together with current GAAM authority, evidence, runtime and accountability requirements. The experimental record is supporting research evidence only.

## Governance sequence

1. Establish the current normative authority and governance context.
2. Evaluate the candidate future-evolution condition represented by `FE-023`.
...
- the behavioural vector `jurisdiction-conflict-escalated-valid`;
- a decision or escalation record;
- reviewer observations on whether existing GAAM concepts are sufficient.

## Requirement relationship

This research pattern is anchored in `GAAM-CORE-004` and the Foundation and Runtime Governance profiles. Any additional semantics remain candidates, not v0.9.0 requirements.
