...
---
# Privacy, Security, and Affected-Party Analysis

## Purpose

This page explains the privacy, security, and affected-party analysis for the **Machine-Actionable Governance Package** pattern.
