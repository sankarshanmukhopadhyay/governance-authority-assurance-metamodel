...
| `GOV-FUTURE-DRAFT-PROFILES` | governance | PASS | 7 draft profiles are explicitly non-conformant |
| `SCH-EXPERIMENTAL` | schema | PASS | 10 experimental schemas and examples validated outside the canonical surface |
